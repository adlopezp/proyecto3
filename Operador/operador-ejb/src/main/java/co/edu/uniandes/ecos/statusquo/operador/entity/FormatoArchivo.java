...
public class FormatoArchivo implements Serializable {
    ...
    public FormatoArchivo(Long id) {
        this.id = id;
    }

    public FormatoArchivo(Long id, String nombre, String extencion) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "co.edu.uniandes.ecos.statusquo.operador.entity.FormatoArchivo[ id=" + id + " ]";
    }
