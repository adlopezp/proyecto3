...
@NamedQueries({
    ...
    @NamedQuery(name = "TipoArchivo.findByNombre", query = "SELECT t FROM TipoArchivo t where t.nombre = ?1")})
public class TipoArchivo implements Serializable {
    ...
    public TipoArchivo(Long id) {
        this.id = id;
    }

    public TipoArchivo(Long id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    public String toString() {
        return "co.edu.uniandes.ecos.statusquo.operador.entity.TipoArchivo[ id=" + id + " ]";
    }
